...
knitr::include_graphics("F:\\GitHub\\Chemistry_R\\chemstat-r-github.io\\Image\\PNG_FILE_02\\import.png")
```
...
```{r}
myWD<-setwd("F:/GitHub/Chemistry_R/chemstat-r-github.io")    # Set working directory  
myWD<-setwd("F://GitHub//Chemistry_R//chemstat-r-github.io") # Equivelent
myWD
```
...
dataFolder<-"F:/GitHub/Chemistry_R/chemstat-r-github.io/Data/"
```
...
knitr::include_graphics("F:\\GitHub\\Chemistry_R\\chemstat-r-github.io\\Image\\PNG_FILE_02\\data_table_01.png")
```
...
```{r echo=FALSE, out.width='80%', fig.align="center"}
knitr::include_graphics("F:\\GitHub\\Chemistry_R\\chemstat-r-github.io\\Image\\PNG_FILE_02\\data_table_02.png")
```
...
```{r echo=FALSE, out.width='80%', fig.align="center"}
knitr::include_graphics("F:\\GitHub\\Chemistry_R\\chemstat-r-github.io\\Image\\PNG_FILE_02\\tidyverse.png")
```
...
```{r echo=FALSE, out.width='80%', fig.align="center"}
knitr::include_graphics("F:\\GitHub\\Chemistry_R\\chemstat-r-github.io\\Image\\PNG_FILE_02\\read_readr_function.png")
```
...
```{r echo=FALSE, out.width='100%', fig.align="center"}
knitr::include_graphics("F:\\GitHub\\Chemistry_R\\chemstat-r-github.io\\Image\\PNG_FILE_02\\write_readr_function.png")
```

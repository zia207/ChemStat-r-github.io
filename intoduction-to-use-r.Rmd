...
knitr::include_graphics("F:\\GitHub\\Chemistry_R\\chemstat-r-github.io\\Image\\PNG_FILE_02\\introduction.png")
```
...
knitr::include_graphics("F:\\GitHub\\Chemistry_R\\chemstat-r-github.io\\Image\\PNG_FILE_02\\screen_promote.png")
```
<div style="margin-bottom:10px;">
</div>
...
library(embedr)
embed_video("F:/GitHub/Chemistry_R/chemstat-r-github.io/Vedio/R_calculator.mp4", width = "856", height = "656")
```
...
knitr::include_graphics("F:\\GitHub\\Chemistry_R\\chemstat-r-github.io\\Image\\PNG_FILE_02\\Table_math_function.png")
```
<div style="margin-bottom:15px;">
</div>
...
```{r echo=FALSE, out.width='80%', fig.align="center"}
knitr::include_graphics("F:\\GitHub\\Chemistry_R\\chemstat-r-github.io\\Image\\PNG_FILE_02\\vector_functions.png")
```
<div style="margin-bottom:10px;">
</div>

...
```{r echo=FALSE, out.width='60%', fig.align="center", fig.cap="Download R"}
library(vembedr)
embed_url("https://youtu.be/bvoMiKKVf4U")
```
...
```{r echo=FALSE, out.width='100%', fig.align="center", fig.cap="Install R"}
embed_url("https://youtu.be/JmQ-GAidTWk")
```
<div style="margin-bottom:20px;">
</div>
...
```{r echo=FALSE, fig.align="center", fig.height=8, fig.width=5, out.width='90%'}
...
```{r echo=FALSE, out.width='100%', fig.align="center", fig.cap="Open R"}
embed_url("https://youtu.be/cIubYlD5UVY")
```
<div style="margin-bottom:20px;">
</div>
...
```{r echo=FALSE, out.width='100%', fig.align="center", fig.cap="R-Studio"}
embed_url("https://youtu.be/cEykrCTWOC8")
```
<div style="margin-bottom:20px;">
</div>
...
```{r echo=FALSE, out.width='100%', fig.align="center", fig.cap="Change RStudio Appearance and Themes"}
embed_url("https://youtu.be/dmhqWm4an6g")
```
...
```{r echo=FALSE, out.width='100%', fig.align="center", fig.cap="R Packages or Libraries"}
embed_url("https://youtu.be/xBh7Ti6cvXs")
```
...
```{r echo=FALSE, out.width='100%', fig.align="center", fig.cap="R Markdown"}
embed_url("https://youtu.be/vIcbLhC9whM")
```
